...
const AllTransactionsView
 = ({
  ...
  console.log("Filtered Data:", filteredData); // Log to check if filtering works correctly
  ...
  return (
    <div className="p-5 mx-auto lg:p-10">
      <div className="md:p-5 mx-auto">
        ...
        {/* Table Display */}
        <AllTransactionsTable data={currentItems} loading={loading} columns={allTransactionColumns}/>
